...
function ProdHeaderL() {
  return (
    <>
      <div style={{background:"#E6E9DA"}} className="v-header row no-gutters justify-content-between">
        <div className="d-flex col-md-8 align-items-center justify-content-start p-0 v-mobile">
          ...
          <NavLink style={{textDecoration: 'none'  ,color: "#494949" , marginLeft:"100px"}} to="/植物租賃" activeClassName="v-selected" className="menu1" >
              <div><p className="m-0">植物租賃</p></div>
           </NavLink>
           <NavLink style={{textDecoration: 'none' ,color: "#494949"}} to="/saleprod" activeClassName="v-selected2" className="menu1"  >
